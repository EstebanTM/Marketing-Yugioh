...
<div class="container-fluid d-flex justify-content-center">
    ...
    <form class="frmEdit w-50 mx-auto" method="POST" action="updateUsuario.php">
        <h3 class="text-center alert alert-secondary lblTop">Editar usuario</h3>
        <?php
            ...
            while($datos=$result->fetch_object()){?>
                ...
                <div class="mb-3">
                    <label for="locat" class="form-label">Usuario</label>
                    <input type="email" class="form-control" id="descripcion" name="usuario" value="<?= $datos->Usuario ?>">
                </div>
                <div class="mb-3">
                    <label for="locat" class="form-label">Contraseña</label>
                    <input type="text" class="form-control" id="ubicacion" name="password" value="<?= $datos->Contrasenia ?>">
                </div>
                <div class="mb-3">
                    <label for="locat" class="form-label">Tipo</label>
                    <input type="number" class="form-control" id="capacidad" name="tipo" value="<?= $datos->Tipo ?>">
                </div>
            <?php }
            ?>
